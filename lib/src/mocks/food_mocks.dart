const foodsJson = [
  {
    ...
    "foodInfo":
        "Picanha burger with green something, well well well yes it means vegetables on it, belly delicious",
  ...
  {
    "id": "2",
    "food_name": "Pistachios Experiment",
    "foodInfo":
        "Pistachios bread with plant based mysterious universe inside, Like a bio something without solvents!",
    "burgerType": "Vegan Experiment",
    "foodImage":
  ...
  },
  {
    ...
    "food_name": "Chicken X",
    "foodInfo":
        "Chicken delicious combining a flavor universe of secret sauces ",
    "burgerType": "Low-Carb Diet with extra flavonoides",
    "foodImage":
